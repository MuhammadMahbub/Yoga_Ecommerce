            ...
            <div class="card-body">
                <div class="row my-2">
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <p class="card-text">Available - <span class="text-success">In stock ({{ $product->quantity }} left)</span></p>
                        @elseif($product->quantity < 10)
                        <p class="card-text">Available - <span class="text-warning">Low stock ({{ $product->quantity }} left)</span></p>
                        @else
