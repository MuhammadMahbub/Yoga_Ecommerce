...
{{-- Title --}}
@section('title')
    {{ config('app.name') }} | {{ __("Create Yoga Class") }}
@endsection

{{-- Active Menu --}}
@section('yogaclassCreate')
    active
@endsection
...
@section('content')
    <div class="row justify-content-center">
        <div class="col-xxl-9">
            <form action="{{ route('yogaclass.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-editor-wrapper">
                                                <div class="custom-editor">
                                                    {!! old('health_hygiene.fr') !!}
                                                </div>
                                                <input type="hidden" name="health_hygiene[fr]" class="custom-editor-input">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-editor-wrapper">
                                                <div class="custom-editor">
                                                    {!! old('health_hygiene.en') !!}
                                                </div>
                                                <input type="hidden" name="health_hygiene[en]" class="custom-editor-input">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>{{ __("Hosting") }}(FR) </label>
                                            <div class="custom-editor-wrapper">
                                                <div class="custom-editor">
                                                    {!! old('hosting.fr') !!}
                                                </div>
                                                <input type="hidden" name="hosting[fr]" class="custom-editor-input">
                                            </div>
                                            @error('hosting.fr')
                                                <div class="alert alert-danger">
                                                    <div class="alert-body">
                                        ...
                                        <div class="form-group">
                                            <label >{{ __("Hosting") }} (EN)</label>
                                            <div class="custom-editor-wrapper">
                                                <div class="custom-editor">
                                                    {!! old('hosting.en') !!}
                                                </div>
                                                <input type="hidden" name="hosting[en]" class="custom-editor-input">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-editor-wrapper">
                                                <div class="custom-editor">
                                                    {!! old('place_to_stay.fr') !!}
                                                </div>
                                                <input type="hidden" name="place_to_stay[fr]" class="custom-editor-input">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-editor-wrapper">
                                                <div class="custom-editor">
                                                    {!! old('place_to_stay.en') !!}
                                                </div>
                                                <input type="hidden" name="place_to_stay[en]" class="custom-editor-input">
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="map">{{ __("Map") }} <small class="text-info">({{ __('Please provide a ifram') }})</small></label>
